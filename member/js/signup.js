...
var xmlHttp4
	function check_nid(){
		...
		var pid = document.getElementById('Uplink').value;
		...
		url=url+"?action=nid_check&nid="+country+"&&pid="+pid
...
<!-- Start Checking Condition joining -->
function show_alert()
	{
	alert("Coming Soon ");
	}
<!-- Checking Condition  joining end-->
...
function validate()
	...
	if ((userid == null)||(userid <3 || userid > 50)){
	...
	if ((pass == null)||(pass < 6 || pass > 25)){
		alert("Please Enter Password more than 6 charactor ")
		member.password.focus()
		return false
	}
	var mobile= document.getElementById("Mobile").value;            
	if ((mobile==null)||(mobile < 10 || mobile > 15 || mobile.search(/[^0-9\-()+]/g) != -1 )){
