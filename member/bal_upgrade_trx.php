...
if(isset($_SESSION['msg']) || isset($_SESSION['msgs'])){
		...
		if(isset($_SESSION['msgs'])){echo "<font color='green'>".$_SESSION['msgs']."</font>";}
                            ...
                            <div class="content-body">    <div class="row">
                             <div class="col-md-12">
                                ...
                                <div class="col-md-3">
							<h5>Balance: <?php echo "<b>".$bal->stepup."</b>".$t;?></h5>
                                        <form role="form"  action="bal_upgrade_trx_act.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="userid" value="<?php echo $mem->log_id; ?>" placeholder="Enter UserId…">
                                            </div>
		...
		<table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
											...
											<?php $total=0;
				$n=1;
				$query=$mysqli->query("SELECT * FROM `trx` where `send_id`='".$id."' and `type`='4' and `account`='3' order by `serial` desc");
