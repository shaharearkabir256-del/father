                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Product</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Product SKU</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="12345" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Printed T-shirt" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <img class="img-responsive" src="data/eco-products/product-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Rocket Shoppe Inc." class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">A multi colored sleeve for your laptop. It is available in 3 colors</textarea>
                                                </div>
                                            </div>
