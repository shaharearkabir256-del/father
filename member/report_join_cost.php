    ...
    <body class=" ">
        ...
        <div class="page-container row-fluid">
            ...
            <section id="main-content" class=" ">
			  ...
			  <?php $n=1; $total=0;
		$q1=$mysqli->query("SELECT `user_id`,`date`,`invest` FROM `invest` where `invest_id`='".$id."' and `team`<2 "); 
		while($trx=mysqli_fetch_object($q1)){
		$member3=mysqli_fetch_object($mysqli->query("SELECT `log_id` FROM `member` where `user_id`='".$trx->user_id."' "));
		?>								                                           
                                              
        <tr>
        <th class=""  scope="row">Join</th>
        <th class=""  scope="row"><?php echo $n++;?></th>
        <td class=""><?php echo $trx->date;?></td>
		<td class=""><?php echo $member3->log_id;?></td>
        <td class=""><?php echo $trx->invest.$bdt?></td>
        <td class=""><span class="label label-success">Succes<span></td>
        </tr>
<?php $total=$total+$trx->invest; } ?>
	</tbody>
	<tfoot>
                                                <tr>
													<th></th>
