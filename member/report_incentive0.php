                                        ...
                                        <table id="example" class=" display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            <thead>
                                                <tr>
													...
													<th>Date</th>
													<th>#</th>
													<th>Rank Promoted To</th>
													<th>Gift For Honorarium Member</th>
													<th>Amount</th>
...
//SELECT `user`, `left_point`, `right_point`, `left_cary`, `right_cary`, `match`, `flash`, `amount`, `tax`, `date` FROM `matching` WHERE 1
			  $n=1; $total1=0;
		$q1=$mysqli->query("SELECT * FROM `incentive` where `rec_id`='".$id."' order by serial desc "); 
        ...
        <td class=""><?php echo $daily->rank;?></td>
        <td class=""><?php echo $daily->figt;?></td>
