...
<div class="col-md-12 col-xs-12 col-sm-12">
 ...
 <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
											...
											<?php $total=0;
				$n=1;
				$query=$mysqli->query("SELECT * FROM `trx` where `send_id`='".$id."' and `type`='3' and `account`='3' order by `serial` desc");
	...
	<?php $total=$total+$mem->amount; ?>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                        ...
                                        <form role="form"  action="bal_install_trx_act.php" method="POST">
										
                                            <div class="form-group">
                                                <label class="form-label" for="email-1">Member User Name:</label>
