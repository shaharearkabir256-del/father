    ...
    <body class=" ">
        ...
        <div class="page-container row-fluid">
            ...
            <?php require_once("sidebar.php")?>
			 ...
			 <?php  echo"<p style='color:red;font-size:25px;'> P-CHK $planupchk   INV-P $inv_pla->invest P-Up $planup->plan </p>"; ?>			
