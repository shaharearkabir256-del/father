                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Online Shop Settings</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Shop Currency</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="USD" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Tax Percentage</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="5.00%" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Languages</label>
                                                <span class="desc"></span>
                                                <select multiple class="form-control">
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Login User Name</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="USD" class="form-control" id="field-1">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password" value="12345678" class="form-control" id="field-2">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password"  value="12345678" class="form-control" id="field-21">
                                                </div>
                                            </div>
