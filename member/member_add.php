...
<?php
	/* 
		স্যার বলেছেন freedom বাদে অন্য কোনো টাতে ম্যাচিং হবে না এইটা রেকর্ড কোড এর মধ্যে দিয়ে রাখা হলো যেন ভবিষ্যতে উনি না করতে পারে।
	 */
...
<?php } ?>			
				 ...
				 <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select id="memcat" onchange="btnFunction()" name="memcat" class="form-control">
				  ...
				  <div class="col-sm-6">	
				   ...
				   <div class="col-sm-6">  
                      <div class="form-group">
						...
						<table>
							<tr>
								<td><p id="nid_err">Fill Up this field</p></td>
								
								<td><p id="nid_error"></p></td>
							</tr>
						</table>
                      </div>
                  </div>
                ...
                <div class="col-sm-12">
				  <div class="col-sm-6">    
                      <div class="form-group">
                        ...
                        <input id="passOne" onchange="btnFunction()" class="form-control" type="password" name="passOne" value="12345" title="Enter password" placeholder="Enter Password"/>
					...
					<div class="col-sm-6"> 
                        ...
                        <input id="pinOne" onchange="btnFunction()" class="form-control" type="password" name="pinOne" value="1234" title="Enter Pin Code" placeholder="Enter Pin Code"/>
