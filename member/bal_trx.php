...
<?php require_once("head.php")?>
    ...
    <body class=" ">
		...
		if(isset($_SESSION['msgs'])){echo "<font color='green'>".$_SESSION['msgs']."</font>";}
                            ...
                            <div class="content-body">    <div class="row">
                               ...
                               <div class="col-md-3 col-sm-12 col-xs-12">
										<h5>Balance: <?php echo "<b>".$bal->net_bal."</b>".$t;?></h5>
                                        <form role="form"  action="bal_trx_act.php" method="POST">
										
                                            <div class="form-group">
                                                <label class="control-label" for="email-1">Member User Name:</label>
                                                <input type="text" class="form-control"  name="userid" placeholder="Enter UserId…">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label" for="password-1">Amount:</label>
                                                <input type="number" class="form-control"  name="amount" placeholder="Minimum <?php echo $transactionamount." Point";?>">
                                            </div>
											<div class="form-group">
                                                <label class="control-label" for="password-1">Pin:</label>
								...
								<div class="col-md-9 col-sm-12 col-xs-12 table-responsive">
                                        ...
                                        <table id="example" class="table table-hover">
											...
											<?php $total=0;
				$n=1;
				$query=$mysqli->query("SELECT * FROM `trx` where `send_id`='".$id."' and `type`='0' and `account`='3' order by `serial` desc");
        ...
        <td class=""><?php
			$q1=$mysqli->query("SELECT * FROM `member` WHERE `user_id`='".$mem->rec_id."'");
	...
	?>
            ...
            <!-- END CONTENT -->
            <?php require_once('chatapi.php');?>    </div>
        <!-- END CONTAINER -->
