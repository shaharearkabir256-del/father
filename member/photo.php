                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left"><?php echo $page;?><?php if(isset($_SESSION['msg'])){echo "<font color='red'>".$_SESSION['msg']."</font>";} if(isset($_SESSION['msgs'])){echo "<font color='green'>".$_SESSION['msgs']."</font>";}?></h2>
							...
							<div class="form-group" >
								<img src="images/avatar/<?php echo $pro->photo; ?>" width="30%" class="img-thumbnail" ></img>
							</div>
							<div class="form-group" >
