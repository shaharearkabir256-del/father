...
<div class="table-responsive">
    ...
    <tr>
		...
		<td><?php  if($product->offer==1){ echo $product->discount_price.$tk;}else{echo $product->sale_price.$tk; } ?></td>
		...
		<form role="form"  action="prod_req_to_admin_act.php" method="POST">
		  <div class="form-group">
												 ...
												 <input type="number" value="<?php echo $product->serial ?>"  name="sn"  hidden>
												 	<input type="number" value="1547290479" name="recid" hidden>
												<input type="number" value="<?php if($product->offer==1){ echo $product->discount_price;}else{echo $product->sale_price; } ?>"  name="price"  hidden>
