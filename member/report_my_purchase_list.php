...
<table class="table table-hover" id="example">
											...
											<?php $total=0;
				 $n=1; $id=$_SESSION['MemLogId'];
	  $p=mysqli_fetch_object($mysqli->query("select sum(tpoint)as `trp`, sum(tprice)as `tp` from `invoice` where `user_id`='$id' and paid=1 and `type`='0' "));
	  $exeprod=$mysqli->query("select * from `invoice` where `user_id`='$id' and paid=1 and `type`='0' ");
	  while($prod=mysqli_fetch_object($exeprod)){
			...
			?>
                                           ...
                                           <tr>  
																  ...
																  <td class="" width="30%"><?php echo $prod->invoice; ?></td>
																  <td class="" width="30%"><?php echo $prod->sdate; ?></td>
