     ...
     <?php require_once 'header.php';?>
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-primary">
				...
				$n=1; $total=0.00;
				$query=$mysqli->query("SELECT * FROM `dealer_trx` where `rec_id`='".$accounts."' and `status`='1' and `take`='1' ");
				while($trx=mysqli_fetch_object($query)){
				
			?>
               <?php

		$del=mysqli_fetch_object($mysqli->query("SELECT `log_id` FROM `dealer` WHERE `user_id`='".$trx->send_id."'"));
		$adm=mysqli_fetch_object($mysqli->query("SELECT `user` FROM `admin` WHERE `user_id`='".$trx->send_id."'"));
       ...
       <tr <?php if($chkdel==1){ echo "style='background-color: #ecf4f9;'";} ?>>
        ...
        <td class="center">	<?php echo $adm->user.$del->log_id;; ?>	</td>
