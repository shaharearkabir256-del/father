...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $page="Member";?> List</title>
    ...
    <div class="wrapper">
     ...
     <?php require_once 'header.php';?>
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
				...
				$query=$mysqli->query("SELECT * FROM member where `agent_id`='$myid' and `team`='0' ");
				while($mem=mysqli_fetch_object($query)){
				$tre=mysqli_fetch_object($mysqli->query("SELECT * FROM `tree` where user_id='$mem->user_id'"));
			?>
		...
		<?php $pro=mysqli_fetch_object($mysqli->query("SELECT `photo` FROM `profile` where `user_id`='$mem->user_id'")); ?> 
		
		<img src="../member/images/avatar/<?php echo $pro->photo; ?>" class="media-object img-thumbnail user-img" width="60" height="80" alt="User Picture" />
