...
/* 	if ($_FILES['image']['size'] > 1000000) 
	...
	$mysqli->query("UPDATE `dealer_info` SET	`photo`='".$ImageName."' WHERE `user_id`='".$memberid."' ");
		
	$_SESSION['msgs']="Photo change Successful";
	header("Location:$location");
	exit();	
	}
	else
