<?php require_once('session.php'); 		
		$pageName="Withdraw Agent Commission";		
     ...
     <?php require_once 'header.php';?>
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
               <div class="box box-primary">
				...
				$n=1;
				$query=$mysqli->query("SELECT * FROM `withdraw` where `rec_id`='".$id."' and `type`='1' and `status`='1' order by serial desc");
       ...
       <tr <?php if($chkdel==1){ echo "style='background-color: #ecf4f9;'";} ?>>
        ...
        <td class="center"><?php echo $trx->agent_com; $tcom=tcom+$trx->agent_com; ?></td>
