		  ...
		  <div class="col-md-3">
					...
					<div class="box-body">
                                        <form role="form"  action="bal_trx_act.php" method="POST">
											...
											<div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="pin" placeholder="Enter your pin"><br>
												 <button type="submit" class="btn btn-primary  pull-right">Transfer</button><br>
                                            </div>
            ...
            <div class="col-md-9">
               <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Balance Transaction</h3>
                </div><!-- /.box-header -->
...
/* 		$sender=mysqli_fetch_object($mysqli->query("SELECT * FROM `dealer` WHERE `user_id`='".$trx->send_id."' "));
	...
	?></td>-->
        ...
        <td class="center"><span class="label label-success">Succes<span></td>
											...
											<?php $tamount=$tamount+$trx->amount; } ?>
