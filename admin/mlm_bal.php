		...
		<div class="col-md-12">
		 ...
		 <div class="box box-info">
			...
			`g1`, `g2`, `g3`, `g4`, `g5`, `g6`, `g7`, `g8`, `g9`, `g10`, `g11`, `g12`, `g_all` FROM `balance` WHERE 1*/
				$n=1;
	$query=$mysqli->query("SELECT * FROM `balance` where `type`=0 ");	
	...
	<!--<td class="center"><?php echo $bal->matching; ?></td>-->
        ...
        <td class="center"><?php echo $bal->net_bal; ?></td>
					...
					<?php $sponsor=$sponsor+$bal->direct;
							...
							$shopping=$shopping+$bal->shopping;
							$daily=$daily+$bal->daily;
							$gen=$gen+$bal->gen;
							$matching=$matching+$bal->matching;
