		 ...
		 <div class="box box-info">
             <div class="box">
				...
				<table id="example1" class="table table-hover">
											...
											<?php 
				$n=1;
				$query=$mysqli->query("SELECT * FROM `dealer` where serial and `type`=5 order by serial desc ");
...
?>	    
		...
		<a href="dealer_agent_chk.php?userid=<?php echo $mem->user_id; ?>&chk=<?php echo $mem->chk; ?>"><span class='label label-success'>Active</span></a>
		<?php }else{?>
		<a href="dealer_agent_chk.php?userid=<?php echo $mem->user_id; ?>&chk=<?php echo $mem->chk; ?>"><span class='label label-danger'>Inactive</span> </a>
		<?php } ?></td>
		...
		<!--&&location=<!--?php echo $_SERVER[PHP_SELF];?-->
         ...
         <td class="center">
		<a target="_blank" href="dealer_add.php?userid=<?php echo $mem->user_id; ?>"><span class='label label-info'>Edit</span></a>
		</td>
		<td class="center">
		<a target="_blank" href="dealer_login.php?dealer=<?php echo $mem->user_id; ?>"><span class='label label-primary'>Login</span></a>
		</td>
