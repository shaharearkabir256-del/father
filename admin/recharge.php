...
<?php require_once 'side.php';?>
	...
	<div class="row">
             ...
             <div class="box">
				...
				<!-- Main Content Area -->
				 <?php
							...
							<div class="col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <form role="form"  action="recharge_act.php"  autocomplete="off" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary  pull-right">Recharge</button>
                                            </div>
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example1" class="table table-hover">
											...
											<?php 
				$n=1;
				$query=$mysqli->query("SELECT * FROM `trx` where `send_id`='9' and `account`='5' order by serial desc");
        ...
        <th class="center"  scope="row"><?php echo $n++; ?></th><td class="center"><?php echo $mem->trx_id; ?></td>
        <td class="center"><?php echo $mem->day; ?></br>
		<?php echo $mem->time; ?></br>
		<?php echo $mem->date; ?></td>

        <td class="center"><?php
			$q1=$mysqli->query("SELECT * FROM `admin` WHERE `user_id`='".$mem->rec_id."'");
