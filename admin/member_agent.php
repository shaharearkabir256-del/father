...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $page="Agent Management";?></title>
...
<?php require_once 'side.php';?>
	...
	<div class="row">
		 ...
		 <div class="box box-info">
             <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $page;?> | <a href="member_agent_add.php"><i class="fa fa-plus"></i> Add New Agent</a></h3>
                </div><!-- /.box-header -->
				...
				<table id="example1" class="table table-hover">
											...
											<?php 
				$n=1;
				$query=$mysqli->query("SELECT * FROM `member` where `team`=2 ORDER BY serial desc ");
		...
		<td class="center"><?php echo $mem->log_id; ?></td>		<td class="center"><?php 
		...
		<?php } ?>
		<a href="member_edit.php?userid=<?php echo $mem->user_id; ?>"><span class='label label-warning'>Details</span> </a>
		</td>
		...
		<?php } ?></td>
		<td><a href="member_edit.php?userid=<?php echo $mem->user_id; ?>" target="blank"><span class='label label-info'>Edit</span></a></td>
		<td class="center">
