      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Dealer Login Panel</li>
          </ol>
        </section>
        <!-- Main content -->
		...
		<div class="col-md-12">
		 ...
		 <div class="box box-info">
             <div class="box">
				...
				<h1 valign="center" class="title">
				<form action="dealer_login_act.php" method="post">
		<input type="number" name="memberiId" value="<?php $userid=$_GET['dealer']; echo $userid; ?>" hidden >
		
		<button type="submit" class='label label-primary'>Login 
		<?php
				
		$q1=$mysqli->query("SELECT * FROM `dealer` WHERE `user_id`='".$userid."' and `active`='1'");	
