		 ...
		 <div class="box box-info">
             <div class="box">
				...
				<table id="example1" class="table table-hover">
											...
											<?php 
				$n=1;
				$query=$mysqli->query("SELECT * FROM `dealer` where serial and `type`=2 order by serial desc ");
...
?>	    
		...
		<a href="dealer_dh_chk.php?userid=<?php echo $mem->user_id; ?>&chk=<?php echo $mem->chk; ?>"><span class='label label-success'>Active</span></a>
		<?php }else{?>
		<a href="dealer_dh_chk.php?userid=<?php echo $mem->user_id; ?>&chk=<?php echo $mem->chk; ?>"><span class='label label-danger'>Inactive</span> </a>
		<?php } ?></td>
         <td class="center">
