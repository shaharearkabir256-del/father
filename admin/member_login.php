      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Member Login Panel</li>
          </ol>
        </section>
        <!-- Main content -->
		...
		<div class="col-md-12">
		 ...
		 <div class="box box-info">
             <div class="box">
				...
				$mem=$_GET['member_id'];
				?>
				<form action="member_login_act.php" method="post">
		<input type="number" name="memberiId" value="<?php echo $mem; ?>" hidden >
		
		<button type="submit" class='label label-primary'>Login Member Panel</button>
		</form></h1> 
