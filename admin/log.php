		...
		/* 		if(isset($_POST['To'])&&isset($_POST['Message'])){
             ...
             <div class="box">
				...
				<table id="example1" class="table table-striped table-bordered">
									   ...
									   <?php 
									   $n=1;
									   //SELECT `serial`, `user_id`, `pass`, `ip`, `block`, `city`, `country`, `browser`, `status`, `date`, `time`, `day` FROM `hacker` WHERE 1
											$query =$mysqli->query("SELECT * FROM `hacker` ORDER BY serial DESC");
										...
										?>
											...
											<td><?php echo $n++; ?></td>
											<td><?php 
									$member=mysqli_fetch_object($mysqli->query("SELECT * FROM `member` where `user_id`='$slide->user_id' and team=0 "));
									$admin=mysqli_fetch_object($mysqli->query("SELECT * FROM `admin` where `user_id`='$slide->user_id' "));
											if($member->log_id){ 
											echo $member->log_id; echo "<br>";
											echo "member panel";
											}elseif($admin->user){
											echo $admin->user; echo "<br>";
											echo "admin panel";
											}else{
											echo $slide->user_id; echo "<br>";
											echo "customer panel";
											}
											?></td>
											
											<td><p><?php echo $slide->ip; ?></p></td>
											<td><p><?php echo $slide->city; ?></p></td>
											<td><p><?php echo $slide->country; ?></p></td>
											<td><p><?php echo $slide->browser; ?></p></td>
											<td><?php echo $slide->day; ?> <br>
											<?php echo $slide->time; ?><br>
											<?php echo $slide->date; ?>
											</td>
