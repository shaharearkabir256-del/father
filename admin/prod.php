		 ...
		 <div class="box box-info">
             <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><a href="prod_add.php?page=Add New Product">Add New Product</a></h3>
                </div><!-- /.box-header -->
...
<?php 
				$n=1;
				$query=$mysqli->query("SELECT * FROM `prod` order by serial DESC");
				while($mem=mysqli_fetch_object($query)){
			?>
   <tr>
        <th class="center"  scope="row"><?php echo $n++; ?></th>
      
        <td class="center"><?php echo $mem->name; ?></td>
        <td class="center"><?php echo $mem->price; ?></td>
        <td class="center"><?php echo $mem->point; ?></td>
        <td class="center"><?php echo $mem->sdate; ?></td>
        <td class="center"><span class="label label-success">Active<span></td>
        <td class="center">
		<a href="prod_add.php?serial=<?php echo $mem->serial;?>"><span class="label label-primary">Edit<span></a>
		</td>
    </tr>
