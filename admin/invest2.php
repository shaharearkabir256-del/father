		...
		<div class="col-md-12">
		 ...
		 <div class="box box-info">
             <div class="box">
			  ...
			  <?php $n=1; 
//SELECT `serial`, `trx_id`, `user_id`, `invest`, `payable`, `sponsor`, `stepup`, `upline`, `shopping`, `package`, `date`, `chkdate` FROM `invest2` WHERE 1
		$q1=$mysqli->query("SELECT * FROM `invest2` where serial ORDER BY serial DESC ");
		while($daily=mysqli_fetch_object($q1)){
		$member=mysqli_fetch_object($mysqli->query("SELECT `log_id` FROM `member` where `user_id`='".$daily->user_id."' "));
        ...
        <td class=""><?php echo $member->log_id;?></td>
		<td class=""><?php echo $daily->invest;?></td>
		<td class=""><?php echo $daily->upline;?></td>
	
        <td class=""><?php echo $daily->package;?></td>
		<td class=""><?php echo $daily->date;?></td>
		<td class=""><?php echo $daily->chkdate;?></td>
        </tr>
