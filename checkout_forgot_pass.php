...
<?php if(isset($_SESSION['msg'])){ ?>
					...
					<?php if(isset($_SESSION['msgs'])){echo $_SESSION['msgs'];} ?>
                            ...
                            <form class="tzp-form" action="checkout_pincode_send_act.php" method="post">
                                <div class="uk-grid">

									<div class="uk-width-medium-1-1 uk-width-small-1-1 uk-width-1-1 uk-position-relative">
                                        <div class="uk-form-icon uk-width-1-1">
                                            <input type="text" name="lid"  required=""  placeholder="Enter Your User ID" class="uk-width-1-1">
                                        </div>
                                    </div>
									<?php if(isset($_SESSION['msgs'])){ ?>
